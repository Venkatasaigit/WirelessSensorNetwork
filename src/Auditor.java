...
public class Auditor implements ActionListener {
	JFrame jf;
	Container c;
	...
	JLabel mg1, mg2, mg3, mg4, mg5, mg6, mg7, mg8, mg9, mg10, g11, g22, g33,g44, g55, g66, g77;

	String keyWord = "ef50a0ef2c3e3a5fdf803ae9752c8c66";

	Auditor() {
		jf = new JFrame("Auditor :: Privacy Preserving and Truthful Detection of Packet Dropping Attacks");
		c = jf.getContentPane();
		c.setLayout(null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == b1) {
			...
			try {
				...
				String query = "SELECT * FROM auditor";
		...
		public void run() {
			...
			if (this.port == 309)
			{
				...
				try
				{
				    ...
				    connect.createStatement().executeUpdate("insert into auditor values('"+node+"','"+ene+"','"+dt+"')");
